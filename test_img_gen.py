...
from milad_model import milad_net
from data_gen_opt import DataGen, get_data
...
# real_mask = cv2.imread('cityscapes/gtFine/train/zurich/zurich_000069_000019_gtFine_labelIds.png', 0)
# print("real_mask.shape : ", real_mask.shape)
# print("np.unique(real_mask) : ", np.unique(real_mask))

train = DataGen('train', split=True, amount=4)
img, mask = train.__getitem__(0)
...
# chanel = mask_1[:,:,2]
# chanel[chanel > 0] = 255
# cvuint8 = cv2.convertScaleAbs(chanel)
